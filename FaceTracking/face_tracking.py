...
# Load images
background_img = cv2.imread('./Eye-Background.png', cv2.IMREAD_UNCHANGED)       # cv2.imread(): Load an image from a file. Returns a Numpy array
                                                                                # cv2.IMREAD_COLOR(1): default. no alpha channel. 3 channels:BGR
iris_img = cv2.imread('./Eye-Ball.png', cv2.IMREAD_UNCHANGED)                   # cv2.IMREAD_GRAYSCALE(0): load the image in grayscale. 1 channel
